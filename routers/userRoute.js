...
router.get('/order/getInvoice',userware.userLogin,orderController.getInvoice)
...
router.post('/payment_failed',userware.userLogin,orderController.payment_failed)
router.get('/orderPlaced',userware.userLogin,orderController.orderPlaced)
router.get('/pendingPayment',userware.userLogin,orderController.pendingPayment)
router.post('/createOrdertoRetry',userware.userLogin,orderController.createOrdertoRetry)
router.post('/retry-payment',userware.userLogin,orderController.retryPayment)
